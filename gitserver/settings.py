"""
Django settings for gitserver project.
...
SECRET_KEY = 'django-insecure-)vq51_0h#fqmje*dm_p%^*z8kh7=q3paf6x(f*66(w0l7zp%j7'
...
WSGI_APPLICATION = 'gitserver.wsgi.application'
